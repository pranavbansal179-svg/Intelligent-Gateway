...
const styles = {
  ...
  logoRing: {
    ...
    background: "conic-gradient(from 0deg, #6ba3ff, #b366ff, #00d9ff, #6ba3ff)",
    filter: "blur(1px)", opacity: 0.6, animation: "spinSlow 10s linear infinite",
  },
  logoMark: {
  ...
  newChatBtn: {
    ...
    cursor: "pointer", boxShadow: "0 0 20px rgba(107, 163, 255, 0.3)", transition: "all 0.22s var(--ease)",
    flexShrink: 0,
  },
  ...
  emptyTitle: { fontSize: 48, fontWeight: 800, letterSpacing: "-0.035em", lineHeight: 1.15, marginBottom: 18, color: "var(--text-hi)" },
  emptyText: { color: "var(--text-mid)", fontSize: 16, maxWidth: 500, lineHeight: 1.8, marginBottom: 40, fontWeight: 500 },
  tierLegend: { display: "flex", gap: 14, marginBottom: 32, flexWrap: "wrap", justifyContent: "center" },
  tierCard: {
    position: "relative",
    display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 6,
    padding: "20px 22px", background: "rgba(26, 20, 40, 0.5)",
    border: "1px solid rgba(107, 163, 255, 0.15)", borderRadius: 14, minWidth: 165,
    transition: "transform 0.22s var(--ease), box-shadow 0.22s var(--ease)",
    boxShadow: "0 0 12px rgba(107, 163, 255, 0.1)",
  },
  ...
  sendBtn: {
    ...
    transition: "all 0.2s var(--ease)", boxShadow: "0 0 16px rgba(107, 163, 255, 0.35)", minWidth: 92,
  },
