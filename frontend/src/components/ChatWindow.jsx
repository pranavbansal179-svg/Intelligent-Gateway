...
const styles = {
  ...
  logoRing: {
    ...
    background: "conic-gradient(from 0deg, #0a7dd9, #5b62ff, #2563eb, #0a7dd9)",
    filter: "blur(0.8px)", opacity: 0.35, animation: "spinSlow 10s linear infinite",
  },
  logoMark: {
    position: "relative", width: 40, height: 40, borderRadius: 12,
    background: "linear-gradient(135deg, rgba(10, 125, 217, 0.06), rgba(91, 98, 255, 0.04))",
    border: "1px solid rgba(10, 125, 217, 0.12)",
    display: "flex", alignItems: "center", justifyContent: "center",
  },
  logoMark: {
    position: "relative", width: 40, height: 40, borderRadius: 12,
    background: "linear-gradient(135deg, rgba(107, 163, 255, 0.15), rgba(179, 102, 255, 0.1))",
  ...
  newChatBtn: {
    ...
    cursor: "pointer", boxShadow: "0 0 16px rgba(10, 125, 217, 0.2)", transition: "all 0.22s var(--ease)",
    flexShrink: 0,
  },
  ...
  emptyTitle: { fontSize: 48, fontWeight: 800, letterSpacing: "-0.035em", lineHeight: 1.15, marginBottom: 20, color: "var(--text-hi)" },
  emptyText: { color: "var(--text-mid)", fontSize: 15, maxWidth: 520, lineHeight: 1.75, marginBottom: 44, fontWeight: 500 },
  tierLegend: { display: "flex", gap: 14, marginBottom: 32, flexWrap: "wrap", justifyContent: "center" },
  tierCard: {
    position: "relative",
    display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 6,
    padding: "20px 22px", background: "rgba(255, 255, 255, 0.6)",
    border: "1px solid rgba(10, 125, 217, 0.12)", borderRadius: 14, minWidth: 165,
    transition: "transform 0.22s var(--ease), box-shadow 0.22s var(--ease)",
    boxShadow: "0 2px 8px rgba(10, 125, 217, 0.08)",
  },
  ...
  sendBtn: {
    ...
    transition: "all 0.2s var(--ease)", boxShadow: "0 0 14px rgba(10, 125, 217, 0.25)", minWidth: 92,
  },
